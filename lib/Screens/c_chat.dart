// ignore_for_file: prefer_final_fields, unused_element, prefer_const_constructors, avoid_print, avoid_function_literals_in_foreach_calls, annotate_overrides, use_super_parameters, unnecessary_string_interpolations
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async {
                      await _firestore.collection('cmessages').add({
                        'sender': usermail,
