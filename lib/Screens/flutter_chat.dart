// ignore_for_file: prefer_final_fields, avoid_print, unused_element, prefer_const_constructors, avoid_function_literals_in_foreach_calls, use_super_parameters, unnecessary_string_interpolations, annotate_overrides
...
class FlutterChat extends StatefulWidget {
  final String routeid = "flutter/chats";
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed:()async{
                      await _firestore.collection('fluttermessages').add({
                        'sender': usermail,
