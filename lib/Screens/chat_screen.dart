// ignore_for_file: prefer_const_constructors, prefer_final_fields, use_key_in_widget_constructors, library_private_types_in_public_api, avoid_print, unused_element, avoid_function_literals_in_foreach_calls, annotate_overrides, use_super_parameters, unnecessary_string_interpolations
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void messagesstream() async {
    // await for (var snapshot in _firestoreprint('');
    //     .collection('messages')
