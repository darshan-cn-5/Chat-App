...
class NodeChat extends StatefulWidget {
  final String routeid = "nodejs/chat";
  const NodeChat({super.key});

  @override
  State<NodeChat> createState() => _NodeChatState();
}

class _NodeChatState extends State<NodeChat> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed:()async{
                      await _firestore.collection('nodemessages').add({
                        'sender': usermail,
