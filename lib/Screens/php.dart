...
class PhpChats extends StatefulWidget {
  final String routeid = "pho/chats";
  const PhpChats({super.key});

  @override
  State<PhpChats> createState() => _PhpChatsState();
}

class _PhpChatsState extends State<PhpChats> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed:()async{
                      await _firestore.collection('phpmessages').add({
                        'sender': usermail,
