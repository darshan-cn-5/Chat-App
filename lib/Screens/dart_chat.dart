// ignore_for_file: prefer_final_fields, avoid_print, unused_element, avoid_function_literals_in_foreach_calls, prefer_const_constructors, annotate_overrides, use_super_parameters, unnecessary_string_interpolations
...
class DartChat extends StatefulWidget {
  final String routeid = "dart/chats";
  const DartChat({super.key});

  @override
  State<DartChat> createState() => _DartChatState();
}
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async {
                      await _firestore.collection('dartmessages').add({
                        'sender': usermail,
