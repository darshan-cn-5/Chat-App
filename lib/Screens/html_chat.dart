...
class HtmlChats extends StatefulWidget {
  final String routeid = "html/chats";
  const HtmlChats({super.key});

  @override
  State<HtmlChats> createState() => _HtmlChatsState();
}

class _HtmlChatsState extends State<HtmlChats> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async {
                      await _firestore.collection('htmlmessages').add({
                        'sender': usermail,
